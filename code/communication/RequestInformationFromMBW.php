...
class RequestInformationFromMBW extends Object
{
    ...
    public static function set_connection_credentials($a)
    {
        self::$connection_credentials = $a;
    }
    public static function add_connection_credential($key, $value)
    {
        self::$connection_credentials[$key] = $value;
    }
    public static function set_connection_credential_username($s)
    {
        self::$connection_credentials["username"] = $s;
    }
    public static function set_connection_credential_password($s)
    {
        self::$connection_credentials["password"] = $s;
    }
    ...
    public static function set_db_credentials($a)
    {
        self::$db_credentials = $a;
    }
    public static function add_db_connection_credential($key, $value)
    {
        self::$db_credentials[$key] = $value;
    }
    public static function set_db_credentials_saccessarea($s)
    {
        self::$db_credentials["sAccessArea"] = $s;
    }
    public static function set_db_credentials_scustomernumber($s)
    {
        self::$db_credentials["sCustomerNumber"] = $s;
    }
    public static function set_db_credentials_spassword($s)
    {
        self::$db_credentials["sPassword"] = $s;
    }
    public static function set_db_credentials_smethod($s)
    {
        self::$db_credentials["sMethod"] = $s;
    }
